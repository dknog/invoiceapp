...
def receipt():
    ...
    return render_template('receipt.html', download=True, save=False, receipt=receipt, pdf=False)
...
def pdfreceipt(email, receipt_number):
    ...
    return wkhtmltopdf.render_template_to_pdf('receipt.html', receipt=receipt, pdf=True)
